...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 km C:/Users/ad15419/Dropbox/aleks paper/2018/Box Docs/NatCommsSubmission/FFImodelCode/NMDA Depressing synapses with spiking big run/km.mod\n");
