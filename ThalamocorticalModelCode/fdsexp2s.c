...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 FDSExp2Syn C:/Users/ad15419/Dropbox/aleks paper/2018/Box Docs/NatCommsSubmission/FFImodelCode/NMDA Depressing synapses with spiking big run/fdsexp2s.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 94 in file fdsexp2s.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "fdsexp2s.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
